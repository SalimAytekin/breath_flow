...
/**
 * Egzersiz koçluk işlemcisi. MLKit Pose Detection'dan alınan Pose nesnelerini
 * kullanarak
...
public class ExerciseCoachProcessor {
    ...
    private static final String CHANNEL_NAME = "com.breathflow.app/pose_detector";
    private static final String EVENT_CHANNEL_NAME = "com.breathflow.app/pose_data";
    ...
    private final PoseStabilizer poseStabilizer = new PoseStabilizer();
    private final CoachingFeedbackManager feedbackManager = new CoachingFeedbackManager();

    // FPS optimizasyonu için frame throttling
    private long lastProcessTime = 0;
    private static final long PROCESS_INTERVAL_MS = 150; // ~7 FPS (150ms aralık)

    // UI güncelleme throttling
    private long lastFeedbackTime = 0;
    private String lastFeedbackMessage = "";
    private static final long FEEDBACK_INTERVAL_MS = 2000; // 2 saniye minimum

    // Stabilize metrik gönderim throttling
    private long lastMetricsTime = 0;
    private static final long METRICS_INTERVAL_MS = 1000; // 1 saniyede bir metrik güncelle
     ...
     * @param binaryMessenger Flutter binary messenger - null olabilir
     *                        (MainActivity'den kurulduğunda)
     */
    public ExerciseCoachProcessor(Context context, BinaryMessenger binaryMessenger) {
        ...
        // CoachingFeedbackManager listener — feedback değiştiğinde UI'ya gönder
        feedbackManager.setListener(message -> sendFeedbackEvent(message));

        // Method Channel kurulumu - SADECE binaryMessenger null DEĞİLSE
    ...
    public void startExercise(Map<String, Object> exerciseData) {
        ...
        if ("default".equals(analyzerType)) {
            ...
            java.util.List<Map<String, Object>> feedbackRules = (java.util.List<Map<String, Object>>) exerciseData
                    .get("feedback");
            if (rules != null) {
        ...
        if (currentAnalyzer == null) {
            ...
            Log.w(TAG, "❌ Desteklenen egzersizler: "
                    + java.util.Arrays.toString(ExerciseAnalyzerFactory.getSupportedExerciseIds()));
    ...
    public void processPose(Pose pose) {
        ...
        Log.d(TAG, "processPose called - coaching: " + isCoachingEnabled + ", active: " + isExerciseActive
                + ", paused: " + isPaused + ", pose: " + (pose != null));
    ...
    private String getPoseLandmarkTypeName(int landmarkType) {
        switch (landmarkType) {
            case com.google.mlkit.vision.pose.PoseLandmark.NOSE:
                return "NOSE";
            case com.google.mlkit.vision.pose.PoseLandmark.LEFT_EYE_INNER:
                return "LEFT_EYE_INNER";
            case com.google.mlkit.vision.pose.PoseLandmark.LEFT_EYE:
                return "LEFT_EYE";
            case com.google.mlkit.vision.pose.PoseLandmark.LEFT_EYE_OUTER:
                return "LEFT_EYE_OUTER";
            case com.google.mlkit.vision.pose.PoseLandmark.RIGHT_EYE_INNER:
                return "RIGHT_EYE_INNER";
            case com.google.mlkit.vision.pose.PoseLandmark.RIGHT_EYE:
                return "RIGHT_EYE";
            case com.google.mlkit.vision.pose.PoseLandmark.RIGHT_EYE_OUTER:
                return "RIGHT_EYE_OUTER";
            case com.google.mlkit.vision.pose.PoseLandmark.LEFT_EAR:
                return "LEFT_EAR";
            case com.google.mlkit.vision.pose.PoseLandmark.RIGHT_EAR:
                return "RIGHT_EAR";
            case com.google.mlkit.vision.pose.PoseLandmark.LEFT_MOUTH:
                return "LEFT_MOUTH";
            case com.google.mlkit.vision.pose.PoseLandmark.RIGHT_MOUTH:
                return "RIGHT_MOUTH";
            case com.google.mlkit.vision.pose.PoseLandmark.LEFT_SHOULDER:
                return "LEFT_SHOULDER";
            case com.google.mlkit.vision.pose.PoseLandmark.RIGHT_SHOULDER:
                return "RIGHT_SHOULDER";
            case com.google.mlkit.vision.pose.PoseLandmark.LEFT_ELBOW:
                return "LEFT_ELBOW";
            case com.google.mlkit.vision.pose.PoseLandmark.RIGHT_ELBOW:
                return "RIGHT_ELBOW";
            case com.google.mlkit.vision.pose.PoseLandmark.LEFT_WRIST:
                return "LEFT_WRIST";
            case com.google.mlkit.vision.pose.PoseLandmark.RIGHT_WRIST:
                return "RIGHT_WRIST";
            case com.google.mlkit.vision.pose.PoseLandmark.LEFT_PINKY:
                return "LEFT_PINKY";
            case com.google.mlkit.vision.pose.PoseLandmark.RIGHT_PINKY:
                return "RIGHT_PINKY";
            case com.google.mlkit.vision.pose.PoseLandmark.LEFT_INDEX:
                return "LEFT_INDEX";
            case com.google.mlkit.vision.pose.PoseLandmark.RIGHT_INDEX:
                return "RIGHT_INDEX";
            case com.google.mlkit.vision.pose.PoseLandmark.LEFT_THUMB:
                return "LEFT_THUMB";
            case com.google.mlkit.vision.pose.PoseLandmark.RIGHT_THUMB:
                return "RIGHT_THUMB";
            case com.google.mlkit.vision.pose.PoseLandmark.LEFT_HIP:
                return "LEFT_HIP";
            case com.google.mlkit.vision.pose.PoseLandmark.RIGHT_HIP:
                return "RIGHT_HIP";
            case com.google.mlkit.vision.pose.PoseLandmark.LEFT_KNEE:
                return "LEFT_KNEE";
            case com.google.mlkit.vision.pose.PoseLandmark.RIGHT_KNEE:
                return "RIGHT_KNEE";
            case com.google.mlkit.vision.pose.PoseLandmark.LEFT_ANKLE:
                return "LEFT_ANKLE";
            case com.google.mlkit.vision.pose.PoseLandmark.RIGHT_ANKLE:
                return "RIGHT_ANKLE";
            case com.google.mlkit.vision.pose.PoseLandmark.LEFT_HEEL:
                return "LEFT_HEEL";
            case com.google.mlkit.vision.pose.PoseLandmark.RIGHT_HEEL:
                return "RIGHT_HEEL";
            case com.google.mlkit.vision.pose.PoseLandmark.LEFT_FOOT_INDEX:
                return "LEFT_FOOT_INDEX";
            case com.google.mlkit.vision.pose.PoseLandmark.RIGHT_FOOT_INDEX:
    ...
    private String getStartMessage(String exerciseType, Map<String, Object> exerciseData) {
        ...
        switch (exerciseType.toLowerCase()) {
            ...
            default:
                // "neckmovement", "neck_side_bend" ve diğerleri
                // Analyzer kendi başlangıç mesajını üretecek
                return "🎯 " + exerciseName + " başlıyor!\n" +
    ...
    private void evaluateExercise(Pose pose) {
        ...
        try {
            ...
            poseStabilizer.update(pose, result.accuracy);

            // Smoothed accuracy gönder (frame-bazlı dalgalanma yok)
            sendAccuracy(poseStabilizer.getSmoothedAccuracy());

            // CoachingFeedbackManager üzerinden feedback gönder (debounce + priority)
            int priority = CoachingFeedbackManager.detectPriority(result.feedback);
            feedbackManager.proposeFeedback(result.feedback, priority);

            // Stabilize metrikler — 1 saniyede bir gönder
            ...
            feedbackManager.coaching("Analiz hatası oluştu");
            sendAccuracy(0.0);
        }
    }

    /**
     * Stabilize edilmiş metrikleri Flutter/Native UI'ya gönderir.
     */
    private void sendStabilityMetrics() {
        if (eventSink == null)
            return;

        Map<String, Object> data = new HashMap<>();
        data.put("poseQuality", poseStabilizer.getPoseQualityLabel());
        data.put("stability", poseStabilizer.getStabilityLabel());
        data.put("fluidity", poseStabilizer.getFluidityLabel());
        data.put("stabilityScore", poseStabilizer.getStabilityScore());
        data.put("fluidityScore", poseStabilizer.getFluidityScore());
        data.put("movementSpeed", poseStabilizer.getMovementSpeed());

        sendEvent("stability_metrics", data);
    }
    ...
    private void sendPoseData(Map<String, Object> poseData) {
        // Pose data gönderme şu an için devre dışı - sadece coaching feedback'i
        // gönderiyoruz
        // İleride pose skeleton overlay gerekirse burası açılabilir
        /*
         * Log.d(TAG, "sendPoseData called - eventSink: " + (eventSink != null) +
         * ", landmarks: " + (poseData != null ? poseData.size() : "null"));
         * 
         * if (eventSink == null) {
     ...
     */
    /**
     * CoachingFeedbackManager'dan gelen stabilize feedback'i gönderir.
     * Bu metod SADECE FeedbackManager listener tarafından çağrılır.
     */
    private void sendFeedbackEvent(final String message) {
        if (eventSink == null) {
            return;
        }
    ...
    /**
     * Eski API uyumluluğu için sendFeedback wrapper — artık FeedbackManager
     * üzerinden geçer.
     */
    private void sendFeedback(final String message) {
        if (message == null || message.isEmpty())
            return;
        int priority = CoachingFeedbackManager.detectPriority(message);
        feedbackManager.proposeFeedback(message, priority);
    }
