...
- Sleep Journal verileri: tarih, yatma/uyanma saatleri, ruh hali seçimi, rüya notu, uyku kalitesi yorumu.
- Diğer alt koleksiyonlar: aktiviteler, istatistikler, premium kayıtları.
- Analitik & reklam: Firebase Analytics anonim olayları, Crashlytics hata logları, AdMob reklam gösterim istatistikleri.
...
- Hesabınızı doğrudan uygulamadan **Profil → "Hesabı Sil"** butonuyla silebilirsiniz. Tüm Firestore verileri anında kalıcı olarak silinir.
- Alternatif olarak kayıtlı e-postanızla dxdiag.app@gmail.com adresine yazabilirsiniz. Talepler 30 gün içinde sonuçlandırılır.
