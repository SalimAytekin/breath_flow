...
public class LivePreviewPreferenceFragment extends PreferenceFragment {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    setUpPoseDetectionPreferencesForStreamMode();
  }
  ...
  private void setUpPoseDetectionPreferencesForStreamMode() {
    // Poz algılama için gerekli ayarlar
    ListPreference preferGPUPreference =
        (ListPreference)
            findPreference(getString(R.string.pref_key_pose_detector_prefer_gpu));
    preferGPUPreference.setSummary(preferGPUPreference.getEntry());
    preferGPUPreference.setOnPreferenceChangeListener(
        (preference, newValue) -> {
          String newStringValue = (String) newValue;
          int index = preferGPUPreference.findIndexOfValue(newStringValue);
          preferGPUPreference.setSummary(preferGPUPreference.getEntries()[index]);
          return true;
        });
  }
}
