...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _submitForm() async {
    ...
    if (isValid) {
      ...
      // Başarılı giriş durumunda: Eğer bu ekran push ile açıldıysa kapat
      if (mounted && authProvider.isAuthenticated && Navigator.of(context).canPop()) {
        Navigator.of(context).pop();
      }
      // Eğer root ekransa AuthWrapper otomatik yönlendirecek
    }
  }
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      AppStrings.forgotPasswordSpamWarning,
                    ...
                    : () async {
                        ...
                        if (email.isEmpty) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(AppStrings.emailRequired),
